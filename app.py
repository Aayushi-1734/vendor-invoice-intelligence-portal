...
### AI-Driven Frieght Cost Prediction & Invoice Risk Flagging
...
_**Reduce financial leakage and manual workload**
""")
st.divider()
#--------------------------------------------
#Sidebar
...
#--------------------------------------------
    ...
    ***Objective:***
    ...
    if submit_flag:
        ...
        flag_predicted = predict_invoice_flag(input_data)['Predicted_Flag']
